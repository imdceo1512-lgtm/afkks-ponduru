...
const stages = [
    ...
    ['Hand ginning', 'చేతితో విత్తనాల తొలగింపు', 'Wooden plank and iron rolling rod', 'చెక్క పలక మరియు ఇనుప రోలింగ్ రాడ్', 'Each boll is rolled to release its seed while keeping the fibre intact.', 'ప్రతి పత్తి కాయను రోల్ చేసి పీచు చెడిపోకుండా విత్తనాన్ని వేరు చేస్తారు.', 'Tool: Wooden plank and iron rolling rod. Who: Cotton-preparation artisans. Why: Separates seed from fibre. How: Each boll is rolled on a plank until the seed is released.', 'పరికరం: చెక్క పలక, ఇనుప రోలింగ్ రాడ్. ఎవరు: పత్తి తయారీ కళాకారులు. ఎందుకు: పీచు నుంచి విత్తనాన్ని వేరు చేయడానికి. ఎలా: కాయను పలకపై రోల్ చేసి విత్తనాన్ని బయటకు తీస్తారు.', 'image5.jpeg'],
    ['Fibre straightening', 'పీచు సరిచేయడం', 'Balni double-drum roller', 'బల్ని డబుల్ డ్రమ్ రోలర్', 'The balni aligns the fibre for the next preparation stage.', 'తదుపరి తయారీకి బల్ని పీచును సరిచేస్తుంది.', 'Tool: Balni double-drum roller. Who: Spinners and fibre-preparation artisans. Why: Aligns ginned fibre. How: Cotton passes through rollers several times.', 'పరికరం: బల్ని డబుల్ డ్రమ్ రోలర్. ఎవరు: వడికేవారు, పీచు తయారీ కళాకారులు. ఎందుకు: జిన్నింగ్ చేసిన పీచును సరిచేయడానికి. ఎలా: పత్తిని రోలర్ల మధ్య పలుమార్లు పంపుతారు.', 'image7.jpeg'],
    ['Carding', 'కార్డింగ్', 'Carding bow', 'కార్డింగ్ విల్లు', 'A vibrating bow opens cotton into a clean, airy mass.', 'విల్లు కంపనంతో పత్తిని శుభ్రమైన, మెత్తని పీచుగా విడదీస్తారు.', 'Tool: Carding bow. Who: Fibre-preparation artisans. Why: Opens clumps and removes final impurities. How: The bowstring is plucked above the fibre.', 'పరికరం: కార్డింగ్ విల్లు. ఎవరు: పీచు తయారీ కళాకారులు. ఎందుకు: ముద్దలను విడదీయడానికి, చివరి మలినాలను తొలగించడానికి. ఎలా: పీచుపై విల్లు తీగను మీటుతారు.', 'image6.jpeg'],
    ['Sliver preparation', 'స్లైవర్ తయారీ', 'Wooden stick and storage box', 'చెక్క కర్ర మరియు నిల్వ పెట్టె', 'Prepared cotton is gently rolled into slivers before spinning.', 'తయారైన పత్తిని నూలు వడకడానికి ముందు స్లైవర్‌లుగా చుడతారు.', 'Tool: Wooden stick and storage box. Who: Spinners. Why: Creates even material for spinning. How: Prepared cotton is rolled gently into slivers.', 'పరికరం: చెక్క కర్ర, నిల్వ పెట్టె. ఎవరు: వడికేవారు. ఎందుకు: నూలు వడకడానికి సమానమైన పదార్థం చేయడానికి. ఎలా: పత్తిని మృదువుగా స్లైవర్‌లుగా చుడతారు.', 'image12.jpeg'],
    ['Hand spinning', 'చేతితో నూలు వడకడం', 'Single-spindle Gandhi Charkha', 'ఏక కండె గాంధీ చరఖా', 'The spinner draws and twists the sliver into fine, strong yarn.', 'వడికేవారు స్లైవర్‌ను లాగి మెలిక పెట్టి సన్నని, బలమైన నూలుగా మారుస్తారు.', 'Tool: Single-spindle Gandhi Charkha. Who: Spinners. Why: Makes the yarn that defines Ponduru Khadi. How: The sliver is drawn and twisted by hand.', 'పరికరం: ఏక కండె గాంధీ చరఖా. ఎవరు: వడికేవారు. ఎందుకు: పొందూరు ఖాదీకి ప్రత్యేకమైన నూలును తయారు చేయడానికి. ఎలా: స్లైవర్‌ను చేతితో లాగి, మెలిక పెడతారు.', 'image8.jpeg'],
    ['Natural dyeing', 'సహజ రంగులద్దడం', 'Dye vats and drying lines', 'రంగు పాత్రలు మరియు ఎండబెట్టే స్థలం', 'Where colour is required, yarn or cloth is dyed and dried with care.', 'రంగు అవసరమైనప్పుడు నూలు లేదా వస్త్రానికి జాగ్రత్తగా రంగులద్దుతారు.', 'Tool: Dye vats and drying area. Who: Dyeing artisans. Why: Adds colour where required. How: Yarn or cloth is dyed, washed as needed and dried.', 'పరికరం: రంగు పాత్రలు, ఎండబెట్టే స్థలం. ఎవరు: రంగులద్దే కళాకారులు. ఎందుకు: అవసరమైన ఉత్పత్తులకు రంగు ఇవ్వడానికి. ఎలా: నూలు లేదా వస్త్రానికి రంగులద్ది, అవసరమైతే ఉతికి ఎండబెడతారు.', 'image18.jpeg'],
    ['Warping and sizing', 'వార్పింగ్ మరియు సైజింగ్', 'Aasu, bobbins and loom beam', 'ఆసు, బాబిన్లు మరియు మగ్గం బీమ్', 'Yarn is measured, arranged and prepared for the loom.', 'నూలును కొలిచి, అమర్చి, మగ్గంపై నేయడానికి సిద్ధం చేస్తారు.', 'Tool: Aasu, bobbins, sizing brush and loom beam. Who: Warping and weaving artisans. Why: Gives yarn order and strength. How: Yarn is measured, wound and sized before drafting.', 'పరికరం: ఆసు, బాబిన్లు, సైజింగ్ బ్రష్, మగ్గం బీమ్. ఎవరు: వార్పింగ్, నేయు కళాకారులు. ఎందుకు: నూలుకు అవసరమైన క్రమం, బలం ఇవ్వడానికి. ఎలా: నూలును కొలిచి, చుట్టి, సైజింగ్ చేస్తారు.', 'image21.jpeg'],
